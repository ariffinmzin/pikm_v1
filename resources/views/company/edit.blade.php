<x-layouts.app>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
        <form action="{{ route('company.update', $company) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <x-forms.input
                        ...
                        type="date"
                        required
                        :value="old('license_expiry', $company->license_expiry->format('Y-m-d'))"
                    />
                </div>
                ...
                <div>
                    ...
                    <select name="status" id="status" required
                        ...
                        <option value="expired" {{ old('status', $company->status) == 'expired' ? 'selected' : '' }}>Expired</option>
